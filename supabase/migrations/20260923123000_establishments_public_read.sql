-- Rota da Justiça — leitura pública segura do mundo comercial
-- O Rota Admin usa service_role; o jogo usa chave pública.
-- Esta migration garante SELECT + RLS apenas para conteúdo publicado/ativo.
